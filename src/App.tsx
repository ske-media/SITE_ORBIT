...
function App() {
  ...
  return (
    <HelmetProvider>
      ...
      {/* Navigation - Not sticky on homepage, sticky on other pages */}
      <nav className={`w-full z-50 transition-all duration-300 ${
        isHomepage 
          ? 'relative navbar-transparent' 
          : 'fixed bg-black/90 backdrop-blur-sm'
      }`}>
        ...
        <div className={`md:hidden ${isMenuOpen ? 'block' : 'hidden'} ${
          isHomepage ? 'navbar-transparent' : 'bg-black/90 backdrop-blur-sm'
        }`}>
