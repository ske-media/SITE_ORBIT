...
import { 
  Rocket, Check, Globe2, Zap, Shield, Clock, Mail, ChevronDown, 
  ArrowRight, Monitor, Smartphone, Settings, Users, ArrowUp, Timer, 
  CreditCard, Pencil 
} from 'lucide-react';
...
function WebsiteCreation() {
  ...
  <>
    <Helmet>
      ...
      <meta name="description" content="Services de création de sites web sur mesure par l'Agence Orbit" />
    </Helmet>
